...
ActiveRecord::Schema.define(version: 2020_06_08_012620) do
  ...
  create_table "shelves", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "post_flag", default: false
    t.index ["book_id"], name: "index_shelves_on_book_id"
    t.index ["user_id", "book_id"], name: "index_shelves_on_user_id_and_book_id", unique: true
